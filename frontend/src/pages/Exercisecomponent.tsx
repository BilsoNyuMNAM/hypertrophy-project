...
export default function Exercisecomponent({muscletrained, addexercise, Selecttrainedmuscle, MUSCLE_COLORS, muscle, currentDropdown, setCurrentDropdown, isOpen,setOpen, exercise_name, exerciseName, addset, set, id, addsetData, apiCall, setApiCall, weekId, mesoId, logSoreness, existingSoreness}:{muscletrained:string , addexercise:[]| exercise[] , Selecttrainedmuscle:any, MUSCLE_COLORS:any , muscle:string[], currentDropdown:number | null ,setCurrentDropdown: React.Dispatch<React.SetStateAction<number | null>>, isOpen:boolean ,setOpen: React.Dispatch<React.SetStateAction<boolean>>,  exercise_name:string, exerciseName:(e:any)=>void, addset:(exerciseid:number)=>void, set:any, id:number, addsetData:(e:any, exerciseid:number, id:number)=>void, apiCall:Set<unknown>, setApiCall:React.Dispatch<React.SetStateAction<Set<unknown>>>, weekId:string, mesoId:string, logSoreness:any, existingSoreness?:any}){
                    ...
                    <div className="p-5 ">
                        ...
                        <div className="relative  text-[10px] pb-3 mt-1 tracking-[0.12em] text-[#555] uppercase font-spaceMono  select-none">
                            ...
                            <div>
                                ...
                                : set.map((s)=>{return <SetComponent exerciseid={id} setdata={s} addsetData={addsetData}/>})}
                            </div>
